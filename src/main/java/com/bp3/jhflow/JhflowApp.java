package com.bp3.jhflow;

import com.bp3.jhflow.config.ApplicationProperties;
import com.bp3.jhflow.config.DefaultProfileUtil;
...
public class JhflowApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(JhflowApp.class);

    private final Environment env;

    public JhflowApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhflowApp.class);
